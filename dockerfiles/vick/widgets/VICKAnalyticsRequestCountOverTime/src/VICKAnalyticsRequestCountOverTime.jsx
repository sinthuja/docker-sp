...
/**
 * VICKAnalyticsRequestCountOverTime Widget which plots a line graph for request count over time
 */
class VICKAnalyticsRequestCountOverTime extends Widget {
    /**
    ...
    render() {
        if (this.state.faultyProviderConf) {
            return (
                ...
                >
                    Cannot fetch provider configuration for VICK Analytics Request Count Over Time widget.
                </div>
            );
        }
        return (
...
global.dashboard.registerWidget('VICKAnalyticsRequestCountOverTime', VICKAnalyticsRequestCountOverTime);
