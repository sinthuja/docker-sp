...
/**
 * VICKAnalyticsLatencyOverTime Widget which plots a line graph for latency overtime
 */
class VICKAnalyticsLatencyOverTime extends Widget {
    /**
    ...
    render() {
        if (this.state.faultyProviderConf) {
            return (
                ...
                >
                    Cannot fetch provider configuration for VICK Analytics Latency Over Time widget.
                </div>
            );
        }
        return (
...
global.dashboard.registerWidget('VICKAnalyticsLatencyOverTime', VICKAnalyticsLatencyOverTime);
